...
export const MermaidDiagrams: Story = {
  args: {
    content: [
      "## Diagrams",
      "",
      "A `mermaid` fence renders as a diagram; the header toggle swaps it for",
      "the source it was written from.",
      "",
      "```mermaid",
      "flowchart LR",
      "  capture[Capture] --> parse[Parse markdown]",
      "  parse --> index[(Index)]",
      "  parse --> render[Render note]",
      "  index --> search[Search]",
      "  render --> search",
      "```",
      "",
      ...
      "```",
      "",
      "Unparseable source falls back to the code, with the error above it:",
      "",
      "```mermaid",
      "flowchart LR",
      "  a -->",
