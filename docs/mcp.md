...
| `vault_list_pages` | read | Paginated page listing with kind/tags/project |
...
| `vault_create_page` | write | New page; derives the canonical `yyyymmdd.slug.shortid.md` path, declares kind/project |
| `vault_update_page` | write | Whole-field replacement of title/tags/aliases/body |
| `vault_edit_page` | write | Exact-match string edit of the body |
| `vault_append_page` | write | Append to the page or to a heading's section |
