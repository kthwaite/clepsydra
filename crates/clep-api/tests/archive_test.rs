...
use clep_api::api::archive::{ArchiveViewConfig, rollback_cas_with};
use clep_api::api::error::ApiError;
use clep_api::api::events::SyncNotification;
use clep_api::api::{AppState, api_router_with_archive_limit};
use clep_api::vault::archive_hook::ArchiveDeleteHook;
use clep_api::vault::hooks::PostDeleteHook;
use clep_api::vault::index::ArchiveUrlOwner;
use clep_api::vault::rubbish::{RubbishListEntry, RubbishManifest, RubbishStore};
use clep_api::{ServerSettings, TlsSettings};
...
fn setup_archive_view_server() -> (TestServer, TempDir, Arc<AppState>) {
    ...
    let app = Router::new()
        .nest(
            "/api/vault",
            api_router_with_archive_limit(1, view_config, clep_api::FeatureFlags::default()),
        )
